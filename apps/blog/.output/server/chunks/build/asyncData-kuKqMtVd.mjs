import { b as useNuxtApp, c as asyncDataDefaults, a as useRuntimeConfig, d as createError, s as sanitizeTag } from './server.mjs';
...
function useBlogApi() {
  ...
  return {
    getPosts: (params = {}) => $fetch(`${base}/api/blog/public/posts`, { params }).then(unwrap),
    getPost: (id) => $fetch(`${base}/api/blog/public/posts/${id}`).then(unwrap),
    getCategories: () => $fetch(`${base}/api/blog/public/categories`).then(unwrap),
    getTags: () => $fetch(`${base}/api/blog/public/tags`).then(unwrap)
  };
}
defineComponent({
...
export { useAsyncData as a, formatDate as f, useBlogApi as u };
//# sourceMappingURL=asyncData-kuKqMtVd.mjs.map
